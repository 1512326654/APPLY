...
import cn.worldyao.apply.entity.JSONDate;
...
import cn.worldyao.apply.service.UserService;
...
//		modelAndView.addObject("stuGroup", stuGroup);
	...
	@RequestMapping(value = "/afterlogin.do" , method = {RequestMethod.GET}, produces = "text/html;charset=UTF-8")
...
//				modelAndView.setViewName(url);
	...
	public Map<String,Object> isConnection(String name, String openID){
		cn.worldyao.apply.entity.User user = userService.QQCheck(openID);
		Map map = new HashMap();
		if (user != null){
...
/*	@RequestMapping(value = "/reportStatus", method = {RequestMethod.GET}, produces = "text/html;charset=UTF-8")
	...
	public boolean isRegist(String userQQ){
		cn.worldyao.apply.entity.User user = userService.QQCheck(userQQ);
		System.out.println(user);
