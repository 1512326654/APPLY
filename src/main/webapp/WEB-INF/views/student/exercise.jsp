        ...
        success: function (result) {
            ...
            if (excataId == 1){
                $.each(data,function (index, name) {
                    ...
                    if (name.anA){
                        $(".EX" + name.exId).append("<p><input name='" + name.exId + "' type='radio' value='A' title='" + name.anA + "'></p>")
                    }
                    if (name.anB){
                        $(".EX" + name.exId).append("<p><input name='" + name.exId + "' type='radio' value='B' title='" + name.anB + "'></p>")
                    }
                    if (name.anC){
                        $(".EX" + name.exId).append("<p><input name='" + name.exId + "' type='radio' value='C' title='" + name.anC + "'></p>")
                    }
                    if (name.ansD){
                        $(".EX" + name.exId).append("<p><input name='" + name.exId + "' type='radio' value='D' title='" + name.ansD + "'></p>")
                    }
                    if (name.anE){
                        $(".EX" + name.exId).append("<p><input name='" + name.exId + "' type='radio' value='E' title='" + name.anE + "'></p>")
                    }
                    if (name.anF){
                        $(".EX" + name.exId).append("<p><input name='" + name.exId + "' type='radio' value='F' title='" + name.anF + "'></p>")
                    }
                    if (name.anG){
                        $(".EX" + name.exId).append("<p><input name='" + name.exId + "' type='radio' value='G' title='" + name.anG + "'></p>")
                    }
                    if (name.anH){
                        $(".EX" + name.exId).append("<p><input name='" + name.exId + "' type='radio' value='H' title='" + name.anH + "'></p>")
                    }
                    $(".dy-context").append("</div></fieldset>");
                })
            ...
            if ( (excataId == 4 ) || (excataId == 5 ) ){
                $.each(data,function (index, name) {
                    ...
                    $(".EX" + name.exId).append(
                        ...
                        "<textarea name='desc' placeholder='请在此输入答案·····' class='layui-textarea'></textarea>" +
                        "</div>"
                    );
                });
                $(".dy-context").append(
