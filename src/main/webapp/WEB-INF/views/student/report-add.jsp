                        ...
                        <form action="" method="post" class="layui-form layui-form-pane">
                            <div class="layui-form-item">
                                ...
                                <div class="layui-inline groupleader">
                                    ...
                                    <div class="layui-input-inline">
                                        <input disabled class="layui-input dy-input-wd250"
                                               value="${requestScope.info.student.stuName}"/>
                                    </div>
                                </div>
                                <%--显示班级--%>
                                <div class="layui-inline">
                                    ...
                                    <div class="layui-input-inline">
                                        <input disabled class="layui-input dy-input-wd250"
                                               value="${requestScope.info.student.stuClass}"/>
                                    </div>
                                </div>
                            </div>
                            <div class="layui-form-item">
                                ...
                                <div class="layui-inline">
                                    ...
                                    <div class="layui-input-inline">
                                        <input disabled class="layui-input dy-input-wd250"
                                               value="${requestScope.info.student.stuGroup}"/>
                                    </div>
                                </div>
                                <%--显示当前周--%>
                                <div class="layui-inline">
        ...
        <div style="background: rgba(116,184,255,0.6); width: 100% ;color: white; height: 100px ; bottom: 0px ; position: fixed">
            <div class="timeline">
                <div class="events-wrapper">
                    ...
                    <div class="events">
                        <ol id="timeLine">
                            <%--<li><a href="#0" data-date="16/07/2018" class="selected">16 Jan</a></li>--%>
